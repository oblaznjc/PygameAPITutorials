...
def main():
    ...
    # bark_sound_mp3 = pygame.mixer.music.load("bark.mp3")
    ...
    while True:
        ...
        caption2 = font2.render("Bigger Dogs", False, WHITE)
        screen.blit(caption2, (image1.get_width() // 2 - caption1.get_width() // 2, image1.get_height() - 60))
